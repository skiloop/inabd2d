...
mkdir -p $runpath
cd $runpath
../abd2d --rei=0 --niu-type=2 --maxwell-grid=50 --find-grid=24 --is-connect=1 --with-density=1 --tm=1 --total-time=150 | tee co.txt 2>&1 > /dev/null &
cd ..
# No. 6
runpath=m25n40ni
mkdir -p $runpath
cd $runpath
../abd2d --rei=0 --niu-type=2 --maxwell-grid=25 --find-grid=40 --is-connect=1 --with-density=1 --tm=1 --total-time=150 | tee co.txt 2>&1 > /dev/null &
cd ..
# No. 7
runpath=m75n13ni
mkdir -p $runpath
...
mkdir -p $runpath
cd $runpath
../abd2d --rei=0 --niu-type=2 --maxwell-grid=50 --find-grid=25 --is-connect=1 --with-density=1 --tm=1 --total-time=150 | tee co.txt 2>&1 > /dev/null &
cd ..
# No. 1
runpath=m50n2ni
mkdir -p $runpath
...
mkdir -p $runpath
cd $runpath
../abd2d --rei=0 --niu-type=2 --maxwell-grid=50 --find-grid=10 --is-connect=1 --with-density=1 --tm=1 --total-time=150 | tee co.txt 2>&1 > /dev/null &
cd ..
# No. 4
runpath=m50n20ni
mkdir -p $runpath
